! function(t) {
    ...
    var p = new THREE.Color,
        ...
        E = "components",
        w = "object3D";
    AFRAME.registerComponent("animationn", {
        schema: {
            autoplay: {
                default: !0
            },
        ...
        ! function(n, o) {
            ...
            function T(t) {
                ...
                return d.reset = function() {
                    ...
                    var t = V.indexOf(d); - 1 < t && V.splice(t, 1), d.paused = !0
                }, d.play = function() {
            ...
            return T.version = "2.2.0", T.speed = 1, T.running = V, T.remove = function(t) {
                ...
                for (var e = V.length; e--;)
                    for (var n = V[e], r = n.animations, a = r.length; a--;) i(t, r[a].animatable.target) && (r.splice(a, 1), r.length || n.pause())
