...
AFRAME.registerComponent('gui-flex-container', {
    ...
    update: function update() {},
    tick: function tick() {
      console.log("in aframe-gui-component tick for: " + this.el.getAttribute("id"));
      var containerGuiItem = this.el.getAttribute("gui-item");
...
AFRAME.registerComponent('gui-label', {
  ...
  init: function init() {
    ...
    var guiItem = el.getAttribute("gui-item");
    this.guiItem = guiItem;
    guiItem.height = Math.ceil(this.data.value.length / 20) / 2.5;
    el.setAttribute('geometry', 'primitive: plane; height: ' + guiItem.height + '; width: ' + guiItem.width + ';');
  ...
  setText: function setText(newText) {
    ...
    textEntity.setAttribute('troika-text-material', `shader: flat; opacity: ${this.data.opacity};`);
    this.el.appendChild(textEntity);
  }
});
