...
AFRAME.registerComponent('gui-object', {
  ...
  init: function () {
    ...
    el.addEventListener('mouseenter', function (event) {
      ...
      if (typeof hoverActionFunction === "function" && el.getAttribute('visible') != false) hoverActionFunction(event);
    ...
    el.addEventListener(data.on, function (event) {
      el.setAttribute('material', `wireframe: true; color: ${data.activeColor}; opacity: 0;`);
      ...
      if (typeof clickActionFunction === "function" && el.getAttribute('visible') != false) clickActionFunction(event);
